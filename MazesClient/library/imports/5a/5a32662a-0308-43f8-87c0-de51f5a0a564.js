...
cc.Class({
    ...
    showNoAds: function showNoAds() {
        this.noAdsView.active = true;
    },
    hideNoAds: function hideNoAds() {
    ...
    initMissionItem: function initMissionItem(mission, idx) {
    ...
    onWatchVideoBtnClicked: function onWatchVideoBtnClicked() {
    ...
    onMissionItemClicked: function onMissionItemClicked(event) {
        var self = this;
    ...
    showLevelPanel: function showLevelPanel(bid, mid) {
