...
cc.Class({
    ...
    checkMusic: function checkMusic(event, isDis) {
        if (isDis == "turn") {
    ...
    menuShow: function menuShow(event, isShow) {
        if (isShow == "1") {
    ...
    getMoreTimeBtn: function getMoreTimeBtn() {
    ...
    getMoreTime: function getMoreTime(event) {
    ...
    */
    ...
    onNextBtnClicked: function onNextBtnClicked(event, type) {
        var btn = event.target.getComponent(cc.Button);
        btn.interactable = false;
        this.scheduleOnce(function () {
    ...
    onReStarBtnClicked: function onReStarBtnClicked(event, type) {
        var btn = event.target.getComponent(cc.Button);
        btn.interactable = false;
        this.scheduleOnce(function () {
            btn.interactable = true;
    ...
    onShareBtnClicked: function onShareBtnClicked(event, closeSelf) {
        var self = this;
        this.gameApplication.soundManager.playSound("btn_click");
        event.target.getComponent(cc.Button).interactable = false;
